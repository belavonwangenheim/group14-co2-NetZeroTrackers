...
def get_selected_countries(df, value_col='Total'):
    ...
    try:
        ...
        country_stats.columns = [
            'total_records', 'sum_value', 'valid_records', 'mean_value'
        ]
        ...
        # Top-Länder basierend auf Durchschnittswerten (robust gegenüber fehlenden Jahren)
        top_by_mean = (
            country_stats[country_stats.index.isin(quality_countries)]
